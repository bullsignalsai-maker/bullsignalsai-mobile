    ...
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Image
          ...
          resizeMode="contain"
        />
        <Text style={styles.title}>About BullSignalsAI</Text>
      </View>

      <Text style={styles.text}>
        BullSignalsAI is an AI-powered market-insight application designed to
      ...
      <Text style={styles.text}>
        BullSignalsAI does not provide financial, investment, or trading
