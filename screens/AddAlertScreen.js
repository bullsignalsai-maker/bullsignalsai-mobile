...
export default function AddAlertScreen({ route, navigation }) {
  ...
  const hasValidInput = savedAlert
          ...
          <View style={styles.card}>
            <View style={styles.alertHeaderRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.subtitle}>
                  Get notified when {symbol} reaches your selected level.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.livePriceCard}>
              ...
              <View style={styles.liveRight}>
                ...
                {!!session && <Text style={styles.liveSession}>{session}</Text>}
              </View>
            </View>
            {savedAlert && !editing ? (
