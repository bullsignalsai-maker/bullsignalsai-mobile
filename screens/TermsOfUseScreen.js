...
export default function TermsOfUseScreen({ navigation }) {
  ...
  const handleDecline = () => {
    Alert.alert(
      "Notice",
      "You must accept the terms to continue using BullSignalsAI."
    );
    navigation.goBack();
  };
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.body}>
        <Text style={styles.intro}>
          ...
          BullSignalsAI mobile application ("App"), owned and operated for
          informational and educational purposes only.
        </Text>

        <Text style={styles.text}>
          By using BullSignalsAI, you acknowledge that it does not provide
          ...
          Trading and investing involve risk, and BullSignalsAI is not liable
        ...
        <Text style={styles.text}>
          BullSignalsAI uses anonymized analytics and may integrate with APIs
        ...
        <Text style={styles.footer}>
          © 2025 BullSignalsAI. All rights reserved.{"\n"}
